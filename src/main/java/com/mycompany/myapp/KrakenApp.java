...
public class KrakenApp {

    private static final Logger log = LoggerFactory.getLogger(KrakenApp.class);

    private final Environment env;

    public KrakenApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KrakenApp.class);
